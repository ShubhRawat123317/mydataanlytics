...
st.set_page_config(
    page_title='DataPulse Analytics Portal',
    page_icon='📊'
)
...
if file:
    ...
    st.subheader(':blue[Basic information of the dataset]', divider='rainbow')
    ...
    st.warning("Please upload a CSV or Excel file to proceed.", icon='⚠️')

st.subheader(':rainbow[Column Values To Count]', divider='rainbow')
with st.expander('Value Count'):
    if file:  # Ensure a file is uploaded before proceeding
        ...
        st.warning("Please upload a file to use this feature.", icon='⚠️')
